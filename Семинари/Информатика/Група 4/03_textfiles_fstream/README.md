...
_Допълнение: Използвайте аргументи при извикване на програмата за задаване на входните данни_
...
4. Промяна на данните на даден служител по даден служителски номер.
